    ...
    return (
        <div className="w-full h-16 flex items-center justify-between">
            ...
            <span className="relative h-full flex items-center justify-between">
                ...
                <div className={`transform ${isFormVisible ? 'scale-100' : 'scale-0'} origin-top-right transition duration-75 ease-out absolute w-64 h-96 bg-blue-300 top-16 rounded-lg p-5 select-none z-10`}>
